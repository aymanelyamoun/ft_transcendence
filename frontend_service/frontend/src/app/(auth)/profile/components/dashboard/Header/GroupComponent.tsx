...
const GroupComponent: React.FC<GroupComponentProps> = (props) => {
  ...
  const selectedUserId = useSelector(
    (state: RootState) => state.strings.selectedUserId
  );
  ...
  const SendRequestUser = async (props: GroupComponentProps) => {
    try {
      const res = await fetch(
        process.env.NEXT_PUBLIC_BACKEND_URL + "channels/addUserToChannel",
        {
          method: "PATCH",
          mode: "cors",
          credentials: "include",
  ...
  const SendRequestMe = async (props: GroupComponentProps) => {
    try {
      const res = await fetch(
        process.env.NEXT_PUBLIC_BACKEND_URL + "channels/joinChannel",
        {
          method: "PATCH",
          mode: "cors",
          credentials: "include",
  ...
  const UnbanUser = async (props: GroupComponentProps) => {
    try {
      const res = await fetch(
        process.env.NEXT_PUBLIC_BACKEND_URL + "channels/unbanUser",
        {
          method: "PATCH",
          mode: "cors",
          credentials: "include",
          ...
          <>
            ...
            {openPassComp && (
              <ProtectedPassword
                ...
                setOpenPassComp={setOpenPassComp}
              />
            )}
          </>
        )}
