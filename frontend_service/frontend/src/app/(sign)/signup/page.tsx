...
export default function Signup() {
  ...
  return (
    ...
    >
      <h2 className="text-white shadow-2xl text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-3">
        PONG
      </h2>
      <div
        style={gradientStyle}
        ...
        <div className="py-10">
          <div className="flex flex-col items-center ">
            ...
            <InputField
              ...
              value={formData.hashConfirm}
              onChange={(e) =>
                setFormData({ ...formData, hashConfirm: e.target.value })
              }
            />
            ...
            <div className="flex justify-center mb-7 ">
              <Link
                ...
                className="border-2 rounded-full border-gray-200 p-3 mx-1 hover:bg-[#999BD3] "
              >
                <FaGoogle className="text-sm text-white" />
              </Link>
              <Link
                href="http://localhost:3001/api/auth/42/login"
                className="border-2 rounded-full border-gray-200 p-3 mx-1 hover:bg-[#999BD3]"
              >
            ...
            <Link
              href="/signin"
              className=" text-white  px-12 py-2 inline-block font-semibold mb-2 hover:text-[#999BD3]"
            >
              Sign in
            </Link>
          </div>
