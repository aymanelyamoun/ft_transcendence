      ...
      >
        <div className=" px-24 pt-4">
          <div className="scrollbar flex flex-col items-center rounded-t-[10px] h-[581px] overflow-y-auto ">
            <div>
            <Image className='channelImage' src={channleImage} alt={"channelImage"}/>
            </div>
            <div className="">
              <input
            ...
            { !password ? 
              ...
              <div className="passWord relative">
                password
                <div onClick={() => setPassword(true)} className="passwordParameter absolute right-[3%] top-[18%]">
              ...
              <div>
                <div className="fixPasswordBg">
                  <div className="setPassWord relative">
                    password
                      <div onClick={() => setPassword(false)} className="passwordParameter absolute right-[3%] top-[18%]">
                        <Image src= {passwordParameter} alt="password" />
                      </div>
                  </div>
                </div>
                  <div className="typePassword">
                      <div className="flex justify-between">
                        <p className="requiredPasswordText items-end"> required password</p>
                        <div className="mt-[15px] mr-[10px]">
      
                              <label className="relative inline-flex items-center mb-5 cursor-pointer">
                                <input type="checkbox" value="" className="sr-only peer" />
                                <div className="w-9 h-5 bg-green-200 peer-focus:outline-none
                                  rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full
                                   peer-checked:after:border-[#c2ff86] after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300
                                    after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-[#c2ff86]"></div>
                              </label>
                        </div>
                      </div>
                        <div>
                          ...
                          <input className="passwordInput pl-[12px]" type="text" />
                        </div>
                        <div>
                          <div>
