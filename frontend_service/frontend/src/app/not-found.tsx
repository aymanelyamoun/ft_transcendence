    ...
    const gradientStyle = {
      ...
      return (
          ...
          <div style={gradientStyle} className='fixed top-8 left-1/4 transform -translate-x-1/2 -rotate-6 w-[20vh] h-[40vh] rounded-lg'></div>
            ...
            <h2 className="text-white shadow-2xl text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-3">404</h2>
            <h2 style={{ color: '#9A9BD3' }} className='shadow-2xl text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-3'> Not Found! </h2>
