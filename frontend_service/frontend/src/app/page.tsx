    ...
    return (
      <div id='matter-container' className='h-full w-screen flex flex-col relative'>
          ...
          <div style={{ background: '#050A27' }} className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center h-screen ">
            ...
            <div className=' py-20'>
              <Link style={gradientStyle} href="/signin" className='text-white rounded-full px-24 py-2 inline-block font-semibold hover:bg-[#999BD3] mb-7 shadow-xl animate-pulse'>PLAY</Link>
            </div>
          </div>
      </div>
  );
